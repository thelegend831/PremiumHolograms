...
import net.yetrr.premiumguilds.api.event.guild.GuildCreateEvent;
...
public class GuildCreateListener implements Listener {
    ...
    public void onGuildCreate(GuildCreateEvent event) {
        ...
        if (Config.CREATE_ON_GUILD_CREATE) {
            Location location = guild.getRegion().getCenter().clone().add(Config.DEFAULT_HOLOGRAM_X_OFFSET, Config.DEFAULT_HOLOGRAM_Y_OFFSET, Config.DEFAULT_HOLOGRAM_Z_OFFSET);
